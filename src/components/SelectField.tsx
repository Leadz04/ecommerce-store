  ...
  return (
    <div className={`relative ${className}`} ref={containerRef}>
      ...
      <button
        ...
        disabled={disabled}
        className={`w-full flex items-center justify-between px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900 font-medium transition-colors ${
