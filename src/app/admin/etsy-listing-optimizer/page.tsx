...
export default function EtsyListingOptimizerPage() {
    ...
    const [userListingSearchTerm, setUserListingSearchTerm] = useState('');
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            // Set all results (limit 100) and sort by views
            const allListings = data.listings || [];
            allListings.sort((a: any, b: any) => (b.views || 0) - (a.views || 0));
                                ...
                                {searchResults.map((listing, index) => (
                                    ...
                                    >
                                        <div className="flex flex-col sm:flex-row gap-2">
                                            <div className="flex items-center justify-center w-5 h-5 rounded-full bg-gray-100 text-[9px] font-bold text-gray-400 shrink-0 sm:mt-1">
                                                {index + 1}
                                            </div>
                                                ...
                                                <div className="flex items-center gap-2 mt-1">
                                                    ...
                                                    {listing.url && (
                                                        <a
                                                            ...
                                                            className="ml-auto flex items-center gap-1 text-[9px] font-bold text-indigo-500 hover:text-indigo-700 bg-indigo-50 px-1.5 py-0.5 rounded transition-all"
                                                        >
                                                            <span>Etsy</span>
                                ...
                                <div className="flex-1 overflow-y-auto space-y-4 pr-1 max-h-[500px] lg:max-h-none">
                                    ...
                                    <div>
                                        <div className="flex items-start justify-between gap-4">
                                            <h3 className="text-sm font-bold text-gray-900 leading-tight">{selectedMarketListing.title}</h3>
                                            {selectedMarketListing.url && (
                                                <a
                                                    href={selectedMarketListing.url}
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                                    className="shrink-0 p-2 bg-gray-50 text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-xl border border-gray-100 transition-all shadow-sm"
                                                    title="View on Etsy"
                                                >
                            ...
                            <div className="mb-4">
                                ...
                                <div className="relative mb-3">
                                    ...
                                    <input
                                        ...
                                        value={userListingSearchTerm}
                                        onChange={(e) => setUserListingSearchTerm(e.target.value)}
                                        className="w-full pl-9 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-[11px] focus:ring-2 focus:ring-purple-100 focus:border-purple-400 outline-none transition-all text-gray-900"
                                    />
                                </div>
                                    ...
                                    {loadingUserListings && userListings.length === 0 ? (
                                        ...
                                        userListings
                                            ...
                                            .map((l, index) => (
                                                ...
                                                >
                                                    <div className="flex items-center justify-center w-5 h-5 rounded-full bg-gray-100 text-[9px] font-bold text-gray-400 shrink-0">
                                                        {index + 1}
                                                    </div>
                ...
                <div className="mt-8 sm:mt-10 bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-purple-100 overflow-hidden">
                    <div className="bg-purple-600 px-4 sm:px-8 py-4 sm:py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-base sm:text-lg font-bold text-white uppercase tracking-wider">4. Etsy Optimizer Hub</h2>
                        </div>
